...
while(True):
    ...
    for (x,y,w,h) in object_rect:
        ...
        cv2.putText(frame_detect, str(round(object_height, 3)), (x + int(w/2) - 40, y - 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 2)
        cv2.putText(frame_detect, str(round(object_width, 3)), (x + int(w/2) + 40, y - 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 2)
